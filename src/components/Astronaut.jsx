...
export function Astronaut(props) {
  ...
  // Adjust material colors directly on object reference instead of re-running in useEffect
  if (materials["AstronautFallingTexture.png"]) {
    // Change astronaut color to complement the purple/magenta modern look
    materials["AstronautFallingTexture.png"].color.set("#e0b0ff");
    if (materials["AstronautFallingTexture.png"].emissive) {
      materials["AstronautFallingTexture.png"].emissive.set("#4a0080");
      materials["AstronautFallingTexture.png"].emissiveIntensity = 0.4;
    }
  }
